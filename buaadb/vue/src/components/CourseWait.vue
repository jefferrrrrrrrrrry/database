...
<template>
  <div>
    <el-breadcrumb separator="/" >
      ...
      <el-breadcrumb-item v-if="this.loc==1"><a href='/teacher/courseWait' >待审核课程</a></el-breadcrumb-item>
      <el-breadcrumb-item v-if="this.loc==2"><a href='/manager/work' >审核开课</a></el-breadcrumb-item>
    </el-breadcrumb>
